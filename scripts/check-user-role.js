/**
 * Script pour vérifier le rôle d'un utilisateur dans la base de données
 * Usage: node scripts/check-user-role.js <email>
 * Exemple: node scripts/check-user-role.js admin@blossom.com
 */
...
if (!email) {
  ...
  console.error('   Exemple: node scripts/check-user-role.js admin@blossom.com');
  process.exit(1);
}
