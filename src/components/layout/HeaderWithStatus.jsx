/**
 * Header avec indicateur d'état en temps réel
 * Affichage des métriques importantes dans le header
 */
  ...
  return (
    <div className="hidden lg:flex items-center gap-4 text-xs text-gray-600">
      <div className="flex items-center gap-1">
        ...
        <span>{metrics.todayOrders} commandes</span>
      </div>
      <div className="flex items-center gap-1">
      ...
      <div className="flex items-center gap-1">
        ...
        <span>{metrics.activeUsers} utilisateurs</span>
      </div>
    </div>
  );
};
...
/**
 * Header moderne avec indicateurs d'état
 */
const HeaderWithStatus = ({ onMenuClick, sidebarOpen }) => {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-md border-b-2 border-gray-200 sticky top-0 z-50 shadow-lg overflow-x-hidden">
      ...
      {/* Barre de statut pour les managers */}
      {isManager && (
